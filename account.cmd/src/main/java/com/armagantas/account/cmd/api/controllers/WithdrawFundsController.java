...
import com.armagantas.account.cmd.api.commands.WithdrawFundsCommand;
...
public class WithdrawFundsController {
    ...
    public ResponseEntity<BaseResponse> withdrawFunds(@PathVariable(value = "id") String id,
        ...
        try {
            ...
            return new ResponseEntity<>(new BaseResponse("Withdraw funds request done."), HttpStatus.OK);
