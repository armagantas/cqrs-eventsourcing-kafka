...
public class OpenAccountController {
    ...
    public ResponseEntity<BaseResponse> openAccount(@RequestBody OpenAccountCommand command) {
        ...
        try {
            ...
            return new ResponseEntity<>(new OpenAccountResponse("Bank account has been created succesfully.", id), HttpStatus.CREATED);
        } catch (IllegalArgumentException e) {
            logger.log(Level.WARNING, MessageFormat.format("Bad Request : {0}", e.toString()), e);
